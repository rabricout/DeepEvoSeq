...
def main(args):
    ...
    tb_logger = pl_loggers.TensorBoardLogger(save_dir="lightning_logs/", name='deep/', version='version_'+args.my_model_id)
...
if __name__ == "__main__":
    ...
    m_dir = 'lightning_logs/'+'deep/'+'version_'+args.my_model_id+'/checkpoints/'
    ...
    log_file='lightning_logs/'+'deep/'+'version_'+args.my_model_id+'/metrics_eval.json'
