...
def np_example_to_features(
    ...
    #features['raw_seq_length'] = torch.tensor(np_example['seq_length'][0])    # RAPH: adding raw_seq_length
    features['raw_seq_length'] = torch.full(
        size=[cfg.common.max_recycling_iters + 1],
        fill_value=np_example['seq_length'][0],
        dtype=torch.float32,
    )
