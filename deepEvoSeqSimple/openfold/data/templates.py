...
def _process_single_hit(
    ...
    try:    # RAPH: in some cases the file corresponding to the ID do not exist, so let's just skip it
        with open(cif_path, "r") as cif_file:
            cif_string = cif_file.read()
    except:
        logging.info("Error when reading %s, file doesn't exist.", cif_path)
