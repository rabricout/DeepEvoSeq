...
model.set_species(ids, 'MOUSE')    # only useful for "Species" baseline
...
os.makedirs('runs_position/'+model_id, exist_ok=True)
np.save('runs_position/'+model_id+'/position_eval_values.npy', data_to_save)