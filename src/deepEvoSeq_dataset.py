    ...
    def __getitem__(self, idx):
        ...
        if self.window != -1:
            ...
            if seq_len-self.window > 0:
                ...
                random_start = 0
            end = min(random_start+self.window, seq_len)
            x_tensor = x_tensor[:,random_start:end]
            x = x[:,random_start:end]
            x_a1 = x_a1[random_start:end]
            y = y[random_start:end]
            p = p[random_start:end]
