...
# class DeepEvoSeqAttnHead(nn.Module):
#     def __init__(
#         self,
#         esm_embed_dim: int,
#         nb_amino_acids: int,
...
#         self.proj_in = nn.Linear(esm_embed_dim, attn_dim)
...
#         self.classifier = nn.Linear(attn_dim, nb_amino_acids)
...
# class DeepEvoSeqAttnHeadNature(nn.Module):
#     def __init__(
#         self,
#         nb_species: int,
#         esm_embed_dim: int,
...
#         self.proj_align = nn.Linear(nb_species*32, attn_dim)
...
#         # Project ESM embeddings
#         h = self.proj_in(x)  # [B, S, L, attn_dim]
#         B, S, L, D = h.shape
#         h = h.permute(0, 2, 1, 3)
#         h = h.reshape(B, L, S*D)

#         h = self.proj_align(h)    # [B, L, attn_dim]
...
# class DeepEvoSeqFCNature(nn.Module):
#     def __init__(
#         self,
#         nb_species: int,
#         esm_embed_dim: int,
...
#         self.specs = {'dropout': dropout}

#         # Project ESM embedding to attention space
#         self.proj_in = nn.Linear(esm_embed_dim, internal_dim)
#         self.proj_align = nn.Linear(nb_species*internal_dim, internal_dim)
...
#         # Final classifier head per residue
#         self.classifier = nn.Linear(internal_dim, nb_amino_acids)
...
#         # Project ESM embeddings
#         h = self.proj_in(x)  # [B, S, L, internal_dim]
#         B, S, L, D = h.shape
#         h = h.permute(0, 2, 1, 3)
#         h = h.reshape(B, L, S*D)
...
# class DeepEvoSeqSimpleAttnHeadNature(nn.Module):
#     def __init__(
#         self,
#         nb_species: int,
#         input_dim: int,
...
#         self.proj_in = nn.Linear(input_dim, 32)
...
#         """
#         Args:
#             x: input of shape [B, S, L, 21] (batch, species, residues, aa_idx)
...
# class DeepEvoSeqSimpleFCNature(nn.Module):
#     def __init__(
#         self,
#         nb_species: int,
#         nb_amino_acids: int,
